...
const Skills = () => {
  return (
    <div name='skills' className='w-full h-screen bg-gradient-to-r from-black to-gray-800 text-gray-300 '>
        {/* Container */}
        <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
            <div>
                <p className='text-4xl inline font-bold border-b-4 border-gray-400'>Skills</p>
            ...
            <div className='w-full grid grid-cols-2 sm:grid-cols-4 text-center py-8 '>
                ...
                <div className='hover:scale-110 duration-500'>
                <img className='w-20 mx-auto my-4' src={ReactImage} alt="React icon" />
